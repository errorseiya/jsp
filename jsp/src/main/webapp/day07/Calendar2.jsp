...
<form action="CalendarAccess2" method="get">
...
<div style="display:flex;">
	<p>
		<a href="CalendarAccess2?yaer=<%= year%>&month=<%= month -1%>">前月へ（aタグver）</a>
	</p>
	
	<p>
		<a href="CalendarAccess2?yaer=<%= year%>&month=<%= month +1%>">翌月へ（aタグver）</a>
	</p>
</div>
