...
/**
 * Servlet implementation class CalendarAccess2
 */

@WebServlet("/day7/CalenderAccess2")
public class CalendarAccess2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CalendarAccess2() {
        super();
 ...
 * 呼び出すプログラムからの相対パスで指定。
 */
        RequestDispatcher dispatcher = request.getRequestDispatcher("Calendar2.jsp");
