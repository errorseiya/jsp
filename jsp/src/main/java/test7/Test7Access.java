...
/**
 * Servlet implementation class Test7Access
 */

@WebServlet("/Test7Access")

public class Test7Access extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		prepData(request);
        RequestDispatcher dispatcher = request.getRequestDispatcher("Test7.jsp");
        //  フォワードによるページ遷移
