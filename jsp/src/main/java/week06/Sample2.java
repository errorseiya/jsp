...
public class Sample2 extends HttpServlet {
	...
	public StringBuffer output(String type){
        ...
        sb.append("<a href='Sample61'>リンク</a>");
 
        sb.append("<form action='Sample61' method='get'>");
        sb.append("<input type='submit' value='GET送信' />");
        sb.append("</form>");
 
        sb.append("<form action='Sample61' method='post'>");
...
// http://localhost:8080/jsp/week6/Sample61 でアクセス可能
